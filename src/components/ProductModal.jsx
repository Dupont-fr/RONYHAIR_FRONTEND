...
const ProductModal = ({ product, onClose }) => {
  const handleWhatsAppClick = () => {
    ...
    window.open(`https://wa.me/${WHATSAPP_NUMBERS.SECONDARY}?text=${message}`, '_blank')
  }
      ...
      <div className='modal-container' onClick={(e) => e.stopPropagation()}>
        ...
        <div className='modal-content'>
          <div className='modal-image'>
            ...
            {!product.enStock && (
              <div className='stock-badge out-of-stock large'>Rupture de stock</div>
            )}
          </div>
          ...
          <div className='modal-details'>
            ...
            <div className='detail-section-compact'>
              ...
              <div className='stock-status'>
                <span className={`stock-indicator ${product.enStock ? 'in-stock' : 'out-of-stock'}`}></span>
